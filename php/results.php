<?php
    ...
    if (isset($_SESSION['achievedPointsList'])){
        ...
        // Lands here is result.php is opened in  the browser before visiting any question before
    ...
    if ($total / $maxTotal >= 0.8){
        $exclamation = "You did a WOnderfult Job!";
    }
    else if ($total /$maxTotal >= 0.4){
        $exclamation = "Average AF!";
    }
    else {
        $exclamation = "You definitely need more Education in General Knowledge";
    }
